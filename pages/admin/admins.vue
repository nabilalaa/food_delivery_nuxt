<template>
	<Modal TargetName="update-admins" Title="تعديل المسئولين">
		<form action="#">
	...
	<Modal TargetName="add-admins" Title="اضافة المسئولين">
		<form action="#">
			<div class="grid text-2xl gap-4 mb-4 sm:grid-cols-2">
				<div>
					<label
	...
	<div>
		...
		<div class="flex justify-between items-center flex-wrap mb-5">
			...
			<button
				type="button"
				data-modal-target="add-admins"
				data-modal-toggle="add-admins"
